...
const HUMAN_EVENT_LABELS = {
  ...
  "board_refresh_start": "목록 새로고침 시작",
  "board_refresh_success": "목록 새로고침 완료",
  "board_refresh_http_error": "목록 새로고침 HTTP 오류",
  "board_refresh_error": "목록 새로고침 실패",
  "webview_boot": "화면 초기화",
  "schedule_load_start": "일정 불러오기 시작",
  "schedule_load_success": "일정 불러오기 완료",
  "schedule_load_error": "일정 불러오기 실패",
  "schedule_cleared_for_missing_date": "날짜 일정 비우기",
  "calendar_status": "캘린더 상태 확인",
  "calendar_status_error": "캘린더 상태 확인 실패",
  "daily_defaults_load_error": "기본 일정 불러오기 실패",
  "schedule_settings_load_error": "일정 설정 불러오기 실패",
  "storage_location_load_error": "저장 폴더 불러오기 실패",
  "overlay_visibility_check_error": "위젯 표시 확인 실패",
  "schedule_block_report_stale_date": "지난 날짜 일정 상태 변경 차단",
  "settings_modal_open_error": "설정 창 열기 실패",
  "settings_modal_close_error": "설정 창 닫기 실패",
